...
keyfile = '/etc/letsencrpyt/live/securetrade.sitict.net/privkey.pem'

# certfile - SSL Certificate file
certfile = '/etc/letsencrpyt/live/securetrade.sitict.net/cert.pem'
...
ca_certs = '/etc/letsencrpyt/live/securetrade.sitict.net/chain.pem'
